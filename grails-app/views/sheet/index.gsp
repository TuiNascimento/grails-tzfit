...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="create" action="create"><g:message code="${controllerName}.index.title" args="[entityName]"/></g:link></li>
    </ul>
</div>

<div id="list-sheet" class="content scaffold-list" role="main">
    <h1><g:message code="${controllerName}.index.title" args="[entityName]"/></h1>
